...
/* doc-index.twig */
class __TwigTemplate_63b54d557ba92ac5a32e902d1fa6d37e extends Template
{
    private $source;
    private $macros = [];
...
{% block page_content %}
    ...
    {%- endfor %}
{% endblock %}
", "doc-index.twig", "phar://C:/tools/doctum/doctum.phar/src/Resources/themes\\default/doc-index.twig");
    }
}
