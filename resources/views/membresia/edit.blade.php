        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="card-title">
                            <i class="fas fa-edit"></i> {{ __('Editar Membresía') }}
                        </span>
                ...
                <div class="card-body bg-white">
                    ...
                    <form method="POST" action="{{ route('membresias.update', $membresia->id) }}" role="form">
                        {{ method_field('PATCH') }}
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="descripcion" 
                                              ...
                                              id="descripcion" 
                                              rows="3"
                                              required>{{ old('descripcion', $membresia->descripcion) }}</textarea>
                                    @error('descripcion')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="costo" 
                                           value="{{ old('costo', $membresia->costo) }}"
                                           required>
                                    @error('costo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="duracion" 
                                           value="{{ old('duracion', $membresia->duracion) }}"
                                           required>
                                    @error('duracion')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
